...
export function ProjectCard({ title, overview, onClick }) {
  return (
    ...
    >
      ...
      {/* overview */}
      <p className="text-sm sm:text-base text-primary-text-secondary mb-4 sm:mb-6 leading-relaxed">{overview}</p>
